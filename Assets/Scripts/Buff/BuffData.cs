...
namespace Buff
{
    ...
    public class BuffData : ScriptableObject
    {
        ...
        public int maxStack;
        public string[] tags;
        [Header("时间信息")] public bool isForever;
        public float duration;
        public float tickTime;
        [Header("更新方式")] public BuffUpdateTimeEnum buffUpdateTime;
        public BuffRemoveStackUpdateEnum buffRemoveStackUpdate;
        [Header("基础回调点")] public BaseBuffModule OnCreate;
        public BaseBuffModule OnRemove;
        public BaseBuffModule OnTick;
        [Header("伤害回调点")] public BaseBuffModule OnHit;
